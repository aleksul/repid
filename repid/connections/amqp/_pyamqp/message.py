...
class MessageDict(TypedDict):  # needed for use with spread operator
    ...
    header: Header | None
    delivery_annotations: dict[str | bytes, Any] | None
    message_annotations: dict[str | bytes, Any] | None
    properties: Properties | None
    application_properties: dict[str | bytes, Any] | None
    body: bytes | None
    sequence: list[Any] | None
    value: Any | None
    footer: dict[Any, Any] | None
...
class Properties:
    ...
    message_id: str | bytes | UUID | None = None
    user_id: str | bytes | None = None
    to: str | bytes | None = None
    subject: str | bytes | None = None
    ...
    group_id: str | bytes | None = None
    group_sequence: int | None = None
    reply_to_group_id: str | bytes | None = None
...
class Message:
    ...
    _code: ClassVar[int] = 0
    _definition: ClassVar[tuple[tuple[int, FIELD], ...]] = (
    ...
    delivery_annotations: dict[str | bytes, Any] | None = None
    message_annotations: dict[str | bytes, Any] | None = None
    properties: Properties | None = None
    application_properties: dict[str | bytes, Any] | None = None
