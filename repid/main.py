    ...
    async def run_worker(
        ...
        *,
        ...
        Args:
            ...
            tasks_limit (int, optional): Deprecated alias for
        ...
        if not isinstance(limits, (_NotSet, MessageLimits)):
            raise TypeError("limits must be a MessageLimits instance.")
        if not isinstance(tasks_limit, (_NotSet, int)):
            raise TypeError("tasks_limit must be a positive integer.")
