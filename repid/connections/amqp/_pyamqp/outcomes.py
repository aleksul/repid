...
class Received(DeliveryState):
    ...
    CODE: ClassVar[int | bytes] = 0x00000023

    section_number: Annotated[int, AMQPTAnnotation(AMQPTypes.uint)]
    section_offset: Annotated[int, AMQPTAnnotation(AMQPTypes.ulong)]
...
class Accepted(DeliveryState):
    ...
    CODE: ClassVar[int | bytes] = 0x00000024
...
class Rejected(DeliveryState):
    ...
    CODE: ClassVar[int | bytes] = 0x00000025
...
class Released(DeliveryState):
    ...
    CODE: ClassVar[int | bytes] = 0x00000026
...
class Modified(DeliveryState):
    ...
    CODE: ClassVar[int | bytes] = 0x00000027

    delivery_failed: Annotated[bool | None, AMQPTAnnotation(AMQPTypes.boolean)] = None
    undeliverable_here: Annotated[bool | None, AMQPTAnnotation(AMQPTypes.boolean)] = None
    message_annotations: Annotated[dict | None, AMQPTAnnotation(FieldDefinition.fields)] = None
